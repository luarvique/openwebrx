...
defaultConfig = PropertyLayer(
    ...
    # aprs_igate_dir=None,
    aisreporter_enabled=False,
    aisreporter_udp_hosts="ais.vesselfinder.com",
    aisreporter_udp_ports="5482",
    ...
    # sondehub_callsign=None,
    # sondehub_antenna=None,
    mqtt_enabled=False,
    mqtt_host="localhost",
    mqtt_use_ssl=False,
    paging_filter=True,
    ...
    hfdl_ttl=1800,
    acars_ttl=1800,
    vdl2_ignore_acks=False,
    acars_ignore_acks=False,
    fax_lpm=120,
    fax_min_length=200,
    fax_max_length=1500,
