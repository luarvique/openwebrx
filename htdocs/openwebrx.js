            ...
            try {
                ...
                switch (json.type) {
                    ...
                    case 'secondary_demod':
                        ...
                        var panels = ['wsjt', 'packet', 'pocsag', 'page', 'modbus', 'sstv', 'fax', 'ism', 'hfdl', 'adsb', 'dsc', 'skimmer', 'meshtastic'].map(function(id) {
...
function secondary_demod_init() {
    ...
    ['wsjt', 'packet', 'pocsag', 'page', 'modbus', 'sstv', 'fax', 'ism', 'hfdl', 'adsb', 'dsc', 'skimmer', 'meshtastic'].forEach(function(id){
