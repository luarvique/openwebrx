            ...
            try {
                ...
                switch (json.type) {
                    ...
                    case 'secondary_demod':
                        ...
                        var panels = ['wsjt', 'packet', 'sonde', 'pocsag', 'page', 'sstv', 'fax', 'ism', 'hfdl', 'adsb', 'dsc', 'cwskimmer'].map(function(id) {
...
function secondary_demod_init() {
    ...
    ['wsjt', 'packet', 'sonde', 'pocsag', 'page', 'sstv', 'fax', 'ism', 'hfdl', 'adsb', 'dsc', 'cwskimmer'].forEach(function(id){
